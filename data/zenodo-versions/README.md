...
The repository includes only a minimal example cache (`scipy.json`) to keep the history small; run the fetch script or GitHub Action to regenerate the full set.
