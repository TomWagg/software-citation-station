...
- Name: file-upload-compare.test.ts >> File Upload - Production vs Deployed >> compare file upload on production vs deployed
- Location: __tests__/e2e/file-upload-compare.test.ts:67:7
...
Call log:
  - waiting for locator('#software-loading.hide') to be visible
    23 × locator resolved to hidden <p class="hide" id="software-loading">…</p>
